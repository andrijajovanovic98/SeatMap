...
/**
 * Decorative "welcome party" scene shown behind/around the login card: an elegant
 * couple greeting up front, a few more guests mingling in the background, plus
 * balloons and confetti. Purely presentational — no interactivity.
 * Subtle idle animations are defined in globals.css and disabled under
 * prefers-reduced-motion.
 */
export function LoginScene() {
  return (
    <svg
      className="login-scene pointer-events-none absolute inset-x-0 top-0 h-[300px] w-full select-none"
      viewBox="0 0 520 300"
      preserveAspectRatio="xMidYMin slice"
      aria-hidden="true"
    >
      <defs>
        <radialGradient id="loginGlow" cx="50%" cy="26%" r="72%">
          <stop offset="0%" stopColor="#ffffff" />
          <stop offset="100%" stopColor="#eef0fb" />
        </radialGradient>
      </defs>

      <rect width="520" height="300" fill="url(#loginGlow)" />
